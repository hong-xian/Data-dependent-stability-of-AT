...
from generic import get_model_state, get_arch, get_optim, get_concat_indexed_tensor_loader,\
    get_indexed_loader, get_concat_indexed_loader, add_log, evaluate, generic_init, get_transforms
from pgd_attacker import PGDAttacker
from robust_workers import RobustMinimaxPGDDefender
...
def main(args, logger):
    ...
    ''' get Tensor whole loader '''
    train_loader = get_concat_indexed_tensor_loader(
         args.dataset, batch_size=args.batch_size, root=args.data_dir)
