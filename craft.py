...
def make_data(args):
    ...
    if args.dataset == "SVHN":
        train_set = datasets.SVHN(args.data_path, split="train", download=True, transform=transform_test)
        r_test_set = datasets.SVHN(args.data_path, split='test', download=True, transform=transform_test)
        whole_set = train_set.__add__(r_test_set)
